  ...
  return (
    <div className="flex flex-row items-center justify-between gap-x-4">
      <div className="flex flex-col">
        <h1 className="text-lg md:text-xl font-semdibold">{title}</h1>
        {description && (
          <p className="textxs md:text-sm text-muted-foreground">
            {description}
          </p>
        )}
      </div>
...
export const EntityItem = ({
  ...
  return (
    <Link href={href} prefetch>
      ...
      >
        <CardContent className="flex flex-row items-none justify-between p-0">
